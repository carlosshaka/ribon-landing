...
class LettersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create letter" do
    assert_difference('Letter.count') do
      post letters_url, params: { letter: { logo: @letter.logo, text_id: @letter.text_id, title: @letter.title } }
    end
  ...
  test "should update letter" do
    patch letter_url(@letter), params: { letter: { logo: @letter.logo, text_id: @letter.text_id, title: @letter.title } }
